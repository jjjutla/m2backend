// source: https://github.com/NomicFoundation/hardhat/blob/bcd32259a1439a57a60ca67d2682014d051f5f8a/packages/hardhat-ethers/src/internal/helpers.ts
// slightly modified
module.exports = async function collectLibrariesAndLink (artifact, libraries) {
...
${libraryFQNames}`
      ...
      throw new Error(`You tried to link the contract ${artifact.contractName} with ${linkedLibraryName}, which is not one of its libraries. ${detailedMessage}`)
    }
